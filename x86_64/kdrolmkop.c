...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 KdrOlmKop /u/btessler/netpyneca3/x86_64/kdrolmkop.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/u/btessler/netpyneca3/kdrolmkop.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  ":::INCLUDE \"aux_fun.inc\"\n"
  ":::realpath /usr/site/nrniv/local/mod/aux_fun.inc\n"
